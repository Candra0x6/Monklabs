...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center bg-transparent px-4 py-2 text-sm font-bold font-display uppercase transition-colors hover:bg-border/20 hover:text-primary focus:bg-border/20 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-border/50 data-[state=open]:bg-border/50"
)
